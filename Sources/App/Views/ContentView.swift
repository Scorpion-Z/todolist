        ...
        ZStack(alignment: .bottomTrailing) {
            VStack(alignment: .leading, spacing: 16) {
                ...
                TabView(selection: $selectedTab) {
                    overviewTab
                        .tabItem { Label(AppTab.overview.titleKey, systemImage: AppTab.overview.systemImage) }
                        .tag(AppTab.overview)

                    addTab
                        .tabItem { Label(AppTab.add.titleKey, systemImage: AppTab.add.systemImage) }
                        .tag(AppTab.add)

                    templatesTab
                        .tabItem { Label(AppTab.templates.titleKey, systemImage: AppTab.templates.systemImage) }
                        .tag(AppTab.templates)

                    tasksTab
                        .tabItem { Label(AppTab.tasks.titleKey, systemImage: AppTab.tasks.systemImage) }
                        .tag(AppTab.tasks)
                }
            }
            .padding(24)
